...
%of the GIA folders.
%
%options:   1, using euclidean distance; 
%           2, using NormDotProduct; 
%           3, using normalized ranks followed by euclidean clustering.
%
...
function PlotGlomSimMapBlur(M,option,clusterN,cutoff)

addpath('../plotting')
%option1=euclidean distance; 
%option2=NormDotProduct; 
%option3=normalized ranks;
